...
D inline bool scatter(const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered, const texture_data* device_textures, const material_data& mat_data, curandState* state){
    switch(mat_data.type){
        case material_type::LAMBERTIAN:{
            auto scatter_direction = random_on_hemisphere(rec.normal, state);
