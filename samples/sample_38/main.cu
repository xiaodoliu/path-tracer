...
void cornell_box(){
    ...
    int object_index = 6;
    add_box(host_objects, object_index, point3(130, 0, 65), point3(295, 165, 230), /*material_id=*/1);
    add_box(host_objects, object_index, point3(265, 0, 295), point3(430, 330, 460), /*material_id=*/1);
