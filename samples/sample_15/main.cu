...
int main(){
    ...
    host_materials[2] = material_data{material_type::DIELECTRIC, color(1.0, 1.0, 1.0), /*fuzz=*/0.0, /*refraction_index=*/1.000293 / 1.333}; // left
    host_materials[3] = material_data{material_type::METAL, color(0.8, 0.6, 0.2), /*fuzz=*/1.0}; // right
    ...
    host_objects[3].sphere_data = sphere(point3(1.0, 0, -1.0), 0.5, /*material_id=*/3);
