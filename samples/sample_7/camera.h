...
struct camera{
    ...
    void init(int image_width, double aspect_ratio, double focal_length, double viewport_height, point3 origin){
        this->origin = origin;
    ...
    void render(unsigned char* image, int width, int height,
